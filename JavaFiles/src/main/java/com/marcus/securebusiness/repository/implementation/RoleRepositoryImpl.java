...
import com.marcus.securebusiness.rowMapper.RoleRowMapper;
...
import static com.marcus.securebusiness.query.RoleQuery.*;
...
public class RoleRepositoryImpl implements RoleRepository {
    ...
    public Collection<Role> list() {
        ...
        try {
            ...
            throw new ApiException("An error occurred during fetching all roles. Please try again later");
        }
    }
    ...
    public void addRoleToUser(Long userId, String roleName) {
        ...
        try {
            ...
            throw new ApiException("An error occurred during add role to user. Please try again later");
        }
    }
    ...
    public Role getRoleByUserId(Long userId) {
        ...
        try {
            ...
            throw new ApiException("An error occurred during get Role By UserId. Please try again later");
        }
    }
    ...
    public void updateUserRole(Long userId, String roleName) {
        try {
            ...
            throw new ApiException("An error occurred during update user roles. Please try again later");
        }
    }
